...
public class Employee {
    ...
    public Employee(final PersonalDetailsRecord personalDetails, final EmploymentDetailsRecord employmentDetails, final String password) {
    ...
    public Employee(final PersonalDetailsRecord personalDetailsRec, final EmploymentDetailsRecord employmentDetailsRec) {
        this(personalDetailsRec, employmentDetailsRec, generatePassword());
    }
    ...
    public String toString() {
        // @formatter:off
        return MessageFormat.format("{0}<personalDetails={1}, employmentDetails={2}>",
                                    getClass().getName(),
                                    (personalDetails == null) ? "not available" : personalDetails.toString(),
                                    (employmentDetails == null) ? "not available" : employmentDetails.toString()
                                   );
        // @formatter:on
    }
}
